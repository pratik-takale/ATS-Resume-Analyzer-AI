...
Extracted technical skills, soft skills, and validated technologies detected in the resume.
...
Highlights important keywords from the Job Description that are missing in the resume.

![Missing Keywords](screenshots/missing_keywords.png)

---

### AI Recommendations

Personalized suggestions generated by the AI model to improve the resume.
